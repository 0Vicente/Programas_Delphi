...
cmd1.CommandText := 'insert into soldado (Nombre_s, Apellido_s, Direccion_s, Telefono_s, Profesion_s, Lugar_de_Nac_s, Fecha_de_ingreso_s, Rango_s, fecha_Nac_s, CodCuerpo1, Codcompañia1, Codcuartel1, Codsoldado) values ("'+edtnombre.Text+'", "'+edtApellido.Text+'", "'+edtdireccion.Text+'", "'+edttelefono.Text+'", "'+cbbprofesion.Text+'", "'+cbbLugar_de_Nac_s.Text+'", "'+edtFechaingreso.Text+'", "'+cbbrango.Text+'", "'+edtfecha_de_nac.Text+'", "'+cbbcuerpo.Text+'", "'+cbbcompania.Text+'", "'+cbbcuartel.Text+'", "'+edtcodsoldado.Text+'")';
...
begin
qry1.SQL.Text := 'select Codcompañia from Compañia';
   qry1.Active := True;
...
begin
qry2.SQL.Clear;
qry2.SQL.Add('select * from compañia ');
qry2.SQL.Add(' where codcompañia = "'+ cbbcompania.Text +'" ');
qry2.Open;
if  (ds2.DataSet.FieldValues['codcompañia']) = cbbcompania.Text then
begin
